                ...
                <div class="admin__main-body px-5 py-3">
                    <div class="overflow-auto">
                        <table class="table w-full text-sm text-left min-w-[900px]">
                            ...
                            <tbody>
                                @php
                                    $offset = ($detailOrder->currentPage() - 1) * $detailOrder->perPage();
                                @endphp
                                ...
                                <tr>
                                    ...
                                    <td class="border-[0.5px] px-2 py-[10px] border-[#D2D2D2]">
                                        <div class="max-w-20 h-20">
                                            <img src="{{ $item->Products->image }}" alt="album__1.png" class="w-full h-full object-cover">
                                        </div>
                                    </td>
                                    <td class="border-[0.5px] px-2 py-[10px] border-[#D2D2D2]">
                                        <h3 class="text-sm">
