                            ...
                            <div class="search__box hidden">
                                <div class=" absolute z-[9999] grid gap-y-6 left-0 top-full  p-4 w-[488px] bg-white border border-[#D2D2D2] rounded shadow-[0px_8px_15px_rgba(0,0,0,0.15)]">
                                    <div class="flex items-center">
                                        ...
                                        <input type="date" name="from" class="w-full  text-sm border-b border-[ #D2D2D2] outline-none">
                                    </div>
                                    <div class="flex items-center">
                                        <label class="text-[#212529] text-sm flex-shrink-0 max-w-[128px] w-full">
                                            Tới
                                        </label>
                                        <input type="date" name="to" class="w-full  text-sm border-b border-[ #D2D2D2] outline-none">
                                    </div>
                                    @if ($member->type == 1)
                                    <div class="flex items-center">
                                        <label class="text-[#212529] text-sm flex-shrink-0 max-w-[128px] w-full">
                                    ...
                                    <div class="text-right">
                                        <button type="submit" class="text-white rounded bg-[#2C6CD5] py-1 px-2 text-sm">
                                            Tìm kiếm
                                        </button>
                                    </div>
                                </div>
