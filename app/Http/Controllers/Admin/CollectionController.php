...
class CollectionController extends Controller
{
    ...
    protected function messages()
    {
        return [
            ...
            'image.required' => 'Bạn chưa chọn hình ảnh cho Collection.',
            'categoryId.required' => 'Bạn chưa chọn danh mục Collection.',
        ];
    }
    ...
    {
        if ($request->ajax()) {
            $list_data = Collection::orderBy('created_at', 'DESC')->get();
            return Datatables::of($list_data)
                ...
                ->addColumn('status', function ($data) {
                    ...
                    return '<a href="' . route('collection.edit', ['id' => $data->id ]) . '" title="Sửa">
                            <i class="fa fa-pencil fa-fw"></i> Sửa
                        </a> &nbsp; &nbsp; &nbsp;
                            <a href="javascript:;" class="btn-destroy"
                            data-href="' . route('collection.destroy', $data->id) . '"
    ...
    public function edit($id)
    {
        ...
        $data['data'] = Collection::findOrFail($id);
